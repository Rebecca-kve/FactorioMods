if mods['Krastorio2'] then
  ...
  if settings.startup["braking-force"].value == true then
	...
	data:extend({
      ...
      prerequisites = {"braking-force-8", "kr-advanced-tech-card"},
      unit =
      {
	...
	
    {
      ...
      prerequisites = {"braking-force-11", "kr-singularity-tech-card"},
      unit =
      {
      count_formula = "1.5^(L-8)*800",
      ingredients = {
...
data:extend({
  {
    ...
    icon_size = 128,
    prerequisites = {"worker-robots-storage-3", "kr-advanced-tech-card"},
    effects =
    {
      {
  ...
  
  {
    ...
    icon = "__More_lategame_research__/graphics//capacity.png",
    icon_size = 128,
    prerequisites = {"worker-robots-storage-7", "kr-singularity-tech-card"},
    effects =
    {
      {
        type = "worker-robot-storage",
...
data:extend({
 {
    ...
    prerequisites = {"weapon-shooting-speed-7", "kr-advanced-tech-card"},
    unit =
    {
  ...
  
   {
    ...
    prerequisites = {"weapon-shooting-speed-11", "kr-singularity-tech-card"},
    unit =
    {
      count_formula = "2^(L-7)*1000",
      ingredients = {
...
data:extend({
  {
            ...
            prerequisites = {"inserter-capacity-bonus-8", "kr-advanced-tech-card"},
            unit =
            {
  ...
  },
  {
            ...
            prerequisites = {"inserter-capacity-bonus-11", "kr-singularity-tech-card"},
            unit =
            {
                count_formula = "2^(L-8)*1000",
                ingredients = {
...
data:extend({
  {
    ...
    prerequisites = {"worker-robot-battery-12", "kr-advanced-tech-card"},
    unit =
    {
  ...
  
  {
    ...
    prerequisites = {"worker-robot-battery-15", "kr-singularity-tech-card"},
    unit =
    {
      count_formula = "L*L*50",
      ingredients = {
...

{
    ...
    prerequisites = {"follower-robot-lifetime-4", "kr-advanced-tech-card"},
    unit =
    {
      count_formula = "L*L*50",
       ingredients = {
  ...
  
{
    ...
    prerequisites = {"follower-robot-lifetime-7", "kr-singularity-tech-card"},
    unit =
    {
      count_formula = "L*L*50",
       ingredients = {
...
data:extend({
	{
	  ...
	  prerequisites = {"research-speed-7", "kr-advanced-tech-card"},
	  unit =
	  {
	 	count_formula = "2^(L-7)*1000",
		ingredients = {
	...
	
	{
	  ...
	  prerequisites = {"research-speed-11", "kr-singularity-tech-card"},
	  unit =
	  {
	 	count_formula = "2^(L-7)*1000",
		ingredients = {
...
data:extend({
  {
    ...
    prerequisites = {"laboratory-productivity-5", "kr-advanced-tech-card"},
    unit =
    {
  ...
  
  {
    ...
    prerequisites = {"laboratory-productivity-8", "kr-singularity-tech-card"},
    unit =
    {
      count_formula = "2^(L-5)*3000",
      ingredients = {
